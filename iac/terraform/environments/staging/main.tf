...
module "app_api" {
  ...
  feedback_table_name              = module.feedback_storage.table_name
  dynamodb_feedback_policy_arn     = module.feedback_storage.policy_arn
  attach_feedback_dynamodb_policy  = true
  rate_limit_enabled               = true
  rate_limit_query_per_minute      = 5000
  rate_limit_ingestion_per_minute  = 5000
  rate_limit_collection_per_minute = 1000
  rate_limit_utility_per_minute    = 5000
}
